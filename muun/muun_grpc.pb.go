...
func (c *stockServiceClient) GetStockPrice(ctx context.Context, in *GetStockPriceRequest, opts ...grpc.CallOption) (*GetStockPriceResponse, error) {
	out := new(GetStockPriceResponse)
	err := c.cc.Invoke(ctx, "/muun.StockService/GetStockPrice", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedStockServiceServer) GetStockPrice(context.Context, *GetStockPriceRequest) (*GetStockPriceResponse, error) {
...
func _StockService_GetStockPrice_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/muun.StockService/GetStockPrice",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StockServiceServer).GetStockPrice(ctx, req.(*GetStockPriceRequest))
	}
